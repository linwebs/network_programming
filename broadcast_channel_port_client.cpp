 ...
 * Broadcast change channel port client
...
int main() {
	...
	server_addr.sin_port = htons(BROADCAST_PORT_1);
	...
	cout << "client start listen broadcasting" << endl;
	...
	while (true) {
		...
		switch (now_channel) {
			case 1:
				...
				break;
			case 2:
				server_addr.sin_port = htons(BROADCAST_PORT_2);
				break;
			case 3:
				server_addr.sin_port = htons(BROADCAST_PORT_3);
				break;
			default:
				exit_recv = true;
				break;
